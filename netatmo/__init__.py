...
_CLIENT_ID     = config['NETATMO_ID']   # Your client ID from Netatmo app registration at http://dev.netatmo.com/dev/listapps
_CLIENT_SECRET = config['NETATMO_CLIENT']   # Your client app secret   '     '
_USERNAME      = config['NETATMO_USER']   # Your netatmo account username
_PASSWORD      = config['NETATMO_PASS']   # Your netatmo account password
